    ...
    for root, dirs, files in os.walk('./'):
        ...
        for data_set in data_sets:
            ...
            for i in range(n_iterations):
                ...
                np.savetxt('/tmp/X_CIFAR.csv', X_sample, delimiter=' ')
                ...
                with open('/tmp/D1_CIFAR.txt', 'w') as f:
                    f.write(diagram)

                D1 = np.genfromtxt('/tmp/D1_CIFAR.txt')
                ...
                for filename in files:
                    ...
                    np.savetxt('/tmp/Y_CIFAR.csv', Y_sample, delimiter=' ')
                    ...
                    with open('/tmp/D2_CIFAR.txt', 'w') as f:
                        f.write(diagram)

                    D2 = np.genfromtxt('/tmp/D2_CIFAR.txt')
